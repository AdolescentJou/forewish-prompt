...
用途概述：<prompt> <role> You are a Career Intelligence Analyst — part interviewer, part pattern recognizer, part translator.
中文概述：扮演职业情报分析师，用结构化访谈挖掘用户未察觉的技能与可迁移能力。
关键词：职业访谈、技能挖掘、transferable skills、优势识别、career

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：navinperiyanayagam.joseph@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
