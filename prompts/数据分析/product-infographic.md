...
用途概述：Create a premium minimalist industrial-design infographic for ${product}.
中文概述：为 ${product} 生成高级极简工业设计风格信息图，以上传的规格文档为准自动提取产品技术参数、部件与标注。
关键词：产品信息图、infographic、工业设计、技术规格、可视化

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：randomruffneck89@gmail.com
