...
用途概述：SYSTEM: You are an LLM prompt executor.
中文概述：作为prompt执行者为TikTok生成9:16竖版蓝图风格信息图，分格讲解AI Deepfakes诈骗主题，含编号框与行动要点。
关键词：infographic、信息图、TikTok、AI诈骗、竖版设计、内容生成

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：tracker4devices@gmail.com
