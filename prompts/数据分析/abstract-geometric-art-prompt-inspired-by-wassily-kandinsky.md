...
用途概述：{ "colors": { "color_temperature": "neutral", "contrast_level": "high", "dominant_palette": [ "dark green", "black", "blue", "yellow", "red", "light purple" ] }
中文概述：生成康定斯基风格抽象几何艺术构图提示，含色彩、构图与描述等结构化参数。
关键词：Kandinsky、抽象艺术、几何构图、colors、image prompt
