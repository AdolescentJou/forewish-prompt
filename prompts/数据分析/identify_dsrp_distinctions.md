...
中文概述：扮演创造型发散思考者，识别事物的 distinctions 及其边界、含义与新洞见，借鉴 Derek Cabrera 等系统思维大师视角。
关键词：DSRP、系统思维、distinctions、发散思考、systems thinking

## 元信息（仓库提供）

- 来源仓库：[danielmiessler/Fabric]
- 原始名称：identify_dsrp_distinctions
- 类型：prompt
- 面向开发者：是
