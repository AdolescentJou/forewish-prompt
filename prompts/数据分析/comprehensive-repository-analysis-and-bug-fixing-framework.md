...
用途概述：Act as a comprehensive repository analysis and bug-fixing expert.
中文概述：扮演仓储分析与修 bug 专家，系统排查、分类、修复并文档化全库缺陷与漏洞。
关键词：代码库分析、bug 修复、安全漏洞、repository、缺陷分类

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@ravidulundu](https://github.com/ravidulundu)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
