...
用途概述：--- name: web-typography description: Generate production-grade web typography CSS with correct sizing, spacing, font loading, and responsive behavior based on
中文概述：扮演排版导向的前端工程师，依据Butterick实用排版原则生成生产级web typography CSS，保证字号、行高与响应式正确。
关键词：web typography、CSS、排版规范、前端开发、字体加载、响应式

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：c.aksan@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
