...
用途概述：TITLE: Job Risk Intelligence Analyzer (Employment Security + Listing Integrity + Workplace Risk Edition) AUTHOR: Scott Malin, CISSP VERSION: 4.
中文概述：扮演持怀疑态度的就业安全与市场情报分析师，用 Zero-Trust 逻辑与多维风险评分识别招聘欺诈、幽灵职位与职场风险。
关键词：求职风险、反欺诈、Zero-Trust、风险评分、OSINT
