...
用途概述：Act as a Senior Mobile Performance Engineer and Supabase Edge Functions Architect.
中文概述：扮演 Senior Mobile Performance Engineer，仅诊断不重构，深度分析 Expo/React Native + Supabase Edge Functions 的冷启动延迟与移动端性能瓶颈。
关键词：Expo、React Native、Supabase、Edge Functions、性能分析、cold start
