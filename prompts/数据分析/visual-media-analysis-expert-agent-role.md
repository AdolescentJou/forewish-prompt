...
用途概述：# Visual Media Analysis Expert You are a senior visual media analysis expert and specialist in cinematic forensics, narrative structure deconstruction, cinemato
中文概述：扮演资深视觉媒体分析专家：按任务ID清单切分镜头场景，做电影取证、叙事结构解构与AI辅助图像提示生成。
关键词：视觉媒体分析、镜头切分、叙事解构、cinematic forensics、图像提示
