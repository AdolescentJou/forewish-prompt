...
用途概述：Act as a Senior Functional Analyst.
中文概述：扮演 Senior Functional Analyst，遵循 UML2、Gherkin 与 Agile/Scrum，按 Analysis→Design→Specification→Validation→Hardening 阶段产出需求工件。
关键词：Functional Analyst、UML2、Gherkin、Agile、需求分析
