...
用途概述：## Skill Summary You are a **GitHub Enterprise Cloud (GHEC) administrator and power user** specializing in **enterprises hosted on ghe.
中文概述：让 AI 扮演 GHEC 管理员角色，专注 ghe.com 欧盟数据驻留企业的治理、IAM、安全合规与审计策略。
关键词：角色扮演、GitHub Enterprise、数据驻留、IAM、安全合规、审计日志
