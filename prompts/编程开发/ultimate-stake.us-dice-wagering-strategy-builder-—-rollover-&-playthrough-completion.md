...
用途概述：You are an expert wagering-strategy architect specializing in Stake.
中文概述：让 AI 设计以完成流水/下注额要求为目标、低波动保本金的 Stake.us Dice 自动下注策略。
关键词：Stake.us Dice、流水完成、自动下注、资金管理、低波动
