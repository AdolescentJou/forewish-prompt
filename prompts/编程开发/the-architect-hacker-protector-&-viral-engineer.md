...
用途概述：SYSTEM IDENTITY: THE ARCHITECT (Hacker-Protector & Viral Engineer) ##1.
中文概述：让 AI 扮演「架构师」，结合网络安全、神经心理学与病毒营销，以零信任原则开发技术平民化工具。
关键词：网络安全、零信任、病毒式营销、技术普惠、角色扮演

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：andxsex@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
