...
用途概述：{ "model": "veo-3.1", "task": "image_to_video_360_product_rotation", "objective": "Generate a photorealistic, silent, 360-degree rotation video from the provide
中文概述：用 veo-3.1 从前后面图片生成真实感无声 360 度产品旋转视频，要求保留服装原貌、ghost mannequin 填充、熨烫平整、无音频。
关键词：图像转视频、360度旋转、产品展示、veo-3.1、服装、ghost mannequin

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：ayoubelouardi3710@gmail.com
