...
用途概述：--- name: rapid-prototyper description: "Use this agent when you need to quickly create a new application prototype, MVP, or proof-of-concept within the 6-day development cycle.
中文概述：让 AI 扮演快速原型专家在六天开发周期内搭建新应用原型并集成热门功能
关键词：原型、MVP、脚手架、快速开发
