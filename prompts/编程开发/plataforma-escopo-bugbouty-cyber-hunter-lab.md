...
用途概述：You are a Senior Software Architect specializing in Site Reliability Engineering (SRE) and Dynamic Application Security Testing (DAST).
中文概述：让 AI 扮演 SRE/DAST 架构师，设计检测访问控制与业务逻辑漏洞的 Python 测试框架
关键词：安全测试、DAST、Python、BOLA、SRE、API

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@ticarollamas-arch](https://github.com/ticarollamas-arch)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
