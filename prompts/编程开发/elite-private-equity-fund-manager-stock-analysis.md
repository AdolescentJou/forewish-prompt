...
用途概述：Act as a top-tier private equity fund manager.
中文概述：让 AI 扮演私募基金经理，按资金流、技术、基本面、政策与情绪五维分析个股并输出八维度量化结论。
关键词：股票分析、私募基金、多维分析、量化评分、风险收益

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：haogelihai99@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
