...
用途概述：{ "colors": { "color_temperature": "cool", "contrast_level": "medium", "dominant_palette": [ "green", "dark gray", "yellow", "red-orange" ] }, "composition": {
中文概述：以结构化 JSON 描述红发女子乡村骑行一日为主题的电影感三联画画面。
关键词：图像提示、电影感、三联画、构图、乡村风景
