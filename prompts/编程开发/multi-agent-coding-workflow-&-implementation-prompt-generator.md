...
用途概述：Role: Principal AI Project Manager, Senior Prompt Engineer, and Multi-Agent Workflow Orchestrator.
中文概述：让 AI 扮演项目经理与多智能体编排者，把任务转成面向 Codex、Copilot 等编码 agent 的实施提示
关键词：多智能体、Codex、GitHub Copilot、提示词生成、工作流
