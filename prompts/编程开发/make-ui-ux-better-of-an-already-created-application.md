...
用途概述：You are a senior full-stack engineer and UX/UI architect with 10+ years of experience building production-grade web applications.
中文概述：让 AI 扮演资深全栈工程师兼 UX/UI 架构师，为已有 Web 应用生成覆盖响应式断点与跨设备适配的改进开发计划。
关键词：UI/UX优化、响应式设计、断点策略、Web应用、全栈工程师
