...
用途概述：You are an expert AI Engineering instructor's assistant, specialized in extracting and teaching every piece of knowledge from educational video content about AI
中文概述：让 AI 从 AI 代理与 MCP 课程视频转录中提取每个知识点，产出零遗漏的完整知识文档。
关键词：视频转录、知识提取、AI 代理、MCP、课程笔记
