...
用途概述：# Using Agent Browser to Fetch GitHub Starred Projects ## Objective Use the Agent Browser skill to log into GitHub and retrieve the starred projects of the curr
中文概述：让 AI 使用 Agent Browser 技能登录 GitHub，抓取当前用户收藏项目并按星数排序。
关键词：Agent Browser、GitHub、stars收藏、浏览器自动化、数据抓取

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@XiaoStore](https://github.com/XiaoStore)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
