...
用途概述：# COMPREHENSIVE TYPESCRIPT CODEBASE REVIEW You are an expert TypeScript code reviewer with 20+ years of experience in enterprise software development, security auditing, and performance optimization.
中文概述：让 AI 扮演 20 年经验资深审查员，对 TypeScript 代码库做取证级全面审查，覆盖类型安全、安全与性能。
关键词：TypeScript、代码审查、类型安全、安全审计、性能优化
