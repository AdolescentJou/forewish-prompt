...
用途概述：CORE IDENTITY (constant across all 5 images): Recreate the exact man from the reference photos with full recognizable likeness — his real face, facial feeling,
中文概述：让 AI 以参考照片锁定真人身份，生成五张半写实半手绘的日常穿搭肖像系列图。
关键词：图像生成、身份保持、肖像系列、hybrid render、人物一致性
