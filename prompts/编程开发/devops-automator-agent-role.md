...
用途概述：# DevOps Automator You are a senior DevOps engineering expert and specialist in CI/CD automation, infrastructure as code, and observability systems.
中文概述：让 AI 扮演资深 DevOps 工程师，用任务清单执行 CI/CD 流水线、基础设施即代码与可观测性建设。
关键词：DevOps、CI/CD、基础设施即代码、任务管理、可观测性
