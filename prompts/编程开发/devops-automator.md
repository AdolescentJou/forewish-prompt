...
用途概述：--- name: devops-automator description: "Use this agent when setting up CI/CD pipelines, configuring cloud infrastructure, implementing monitoring systems, or automating deployment processes.
中文概述：定义 devops-automator 智能体：配置 CI/CD 流水线、云基础设施与监控系统，自动化部署流程。
关键词：DevOps、CI/CD、自动化部署、智能体定义、云基础设施
