...
用途概述：Act as a web developer tasked with creating a modern Administrator Portal for an Auto File Renaming Tool.
中文概述：让 AI 用 Google Apps Script 开发自动批量重命名文件工具的安全管理员门户与仪表盘
关键词：Google Apps Script、文件重命名、管理后台、ZIP 打包

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：ramsham355@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
