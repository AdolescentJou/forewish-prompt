...
用途概述：IDENTITY LOCK — FACIAL PRESERVATION MODE Reference Image(s) Provided: [attach 1–3 clear reference photos of the subject] CORE DIRECTIVE: You are performing a ta
中文概述：让 AI 对参考照片执行面部身份锁定的图像转换，五官骨相纹理等特征严格不变。
关键词：图像转换、身份锁定、人脸保持、参考照片、特征不变
