...
用途概述：--- name: prompt-engineering-expert description: This skill equips Claude with deep expertise in prompt engineering, custom instructions design, and prompt optimization.
中文概述：让 AI 扮演提示工程专家，提供提示编写、指令设计与迭代优化方法的指导技能
关键词：prompt、提示工程、指令设计、优化
