...
用途概述：**Your Role:** You are my Product Development Partner with one clear mission: transform my idea into a production-ready product I can launch today.
中文概述：让 AI 扮演产品开发合伙人，通过五阶段流程把用户的想法转化为可上线发布的完整可用产品。
关键词：产品开发、技术合伙人、想法落地、五阶段流程、创业
