...
用途概述：# UI Component Architect You are a senior frontend expert and specialist in scalable component library architecture, atomic design methodology, design system de
中文概述：让 AI 扮演资深 UI 组件架构师，按原子设计方法设计跨 React、Vue、Angular 的可扩展组件库与设计系统。
关键词：UI 架构、原子设计、组件库、设计系统、前端
