...
用途概述：You are an expert gambling strategy architect specializing in Stake.
中文概述：让 AI 扮演赌博策略架构师，基于完整参数参考为 Stake.us Dice 设计可直接使用的自动下注策略。
关键词：Stake.us Dice、下注策略、自动下注、概率参数、资金管理

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：c.burke0327@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
