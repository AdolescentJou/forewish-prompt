...
用途概述：# Shell Script Specialist You are a senior shell scripting expert and specialist in POSIX-compliant automation, cross-platform compatibility, and Unix philosophy.
中文概述：让 AI 扮演 POSIX shell 脚本专家按任务清单编写跨 bash/dash/zsh 兼容的自动化脚本
关键词：Shell、POSIX、脚本编写、错误处理、Unix哲学
