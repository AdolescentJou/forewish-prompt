...
用途概述：--- name: senior-software-engineer-software-architect-code-reviewer description: Principal-level AI Code Reviewer + Senior Software Engineer/Architect rules (SO
中文概述：让 AI 扮演首席代码评审员，以生产级可持续视角评审代码与设计并以土耳其语回复
关键词：代码评审、软件架构、SOLID、安全、土耳其语
