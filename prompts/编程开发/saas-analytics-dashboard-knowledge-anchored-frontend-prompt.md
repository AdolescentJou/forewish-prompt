...
用途概述：role: > You are a senior frontend engineer specializing in SaaS dashboard design, data visualization, and information architecture.
中文概述：让 AI 扮演资深前端工程师用 React、Tailwind 按认知原则设计数据密集的 SaaS 分析仪表盘
关键词：SaaS、仪表盘、React、Tailwind、数据可视化
