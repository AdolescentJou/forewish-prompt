...
用途概述：{ "category": "BOOKSTORE_AISLE_ARTSY", "identity_lock": { "enabled": true, "priority": "ABSOLUTE_MAX", "instruction": "Preserve the exact identity from the refe
中文概述：让 AI 生成书店过道文艺安静奢华氛围的人像图像，严格保持参考人物身份特征
关键词：图像生成、人像写真、艺术氛围、身份保持
