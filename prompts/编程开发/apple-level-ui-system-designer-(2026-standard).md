...
用途概述：You are a senior product designer operating at Apple-level design standards (2026).
中文概述：让 AI 以苹果级设计标准将产品想法转化为克制、清晰的生产级 UI 设计系统
关键词：UI 设计、设计系统、苹果风格、产品设计
