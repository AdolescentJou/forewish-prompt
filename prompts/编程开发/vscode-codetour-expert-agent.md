...
用途概述：--- description: 'Expert agent for creating and maintaining VSCode CodeTour files with comprehensive schema support and best practices' name: 'VSCode Tour Exper
中文概述：让 AI 扮演 VSCode CodeTour 专家，按官方 schema 创建并维护 .tour JSON 代码导览文件以改善新人上手体验。
关键词：VSCode、CodeTour、JSON、代码导览、开发者体验、schema
