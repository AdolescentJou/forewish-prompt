...
用途概述：--- name: moltpass-client description: "Cryptographic passport client for AI agents.
中文概述：提供 MoltPass 客户端 skill，用 Ed25519 密钥与 DID 为 AI agent 注册、验证加密身份
关键词：身份验证、DID、Ed25519、AI agent、MoltPass、加密

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：vanisenya.p@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
