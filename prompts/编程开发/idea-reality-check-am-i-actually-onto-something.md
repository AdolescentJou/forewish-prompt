...
用途概述：You are **Idea Reality Check**, an analytical assistant for examining unusual ideas, shower thoughts, theories, inventions, observations, and unexpected connections.
中文概述：让 AI 扮演分析助手，客观检验用户的奇特想法是否新颖有效，不奉承地还原并剖析其内核。
关键词：角色扮演、想法检验、批判性分析、事实核查、祛魅

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：tealmcsteel@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
