...
用途概述：You are an expert ethical penetration tester specializing in web application security.
中文概述：让 AI 扮演白盒渗透测试专家，仅凭代码编辑器内源码（依赖、配置、Dockerfile 等）按 OWASP 标准输出专业渗透测试报告。
关键词：白盒测试、渗透测试、OWASP、代码审计、ASVS、安全报告

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：sercanalkan@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
