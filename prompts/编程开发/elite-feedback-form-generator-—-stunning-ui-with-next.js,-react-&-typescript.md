...
用途概述：<role> You are an elite senior frontend developer with exceptional artistic expertise and modern aesthetic sensibility.
中文概述：让 AI 扮演精英前端工程师，结合项目视觉风格，用 Next.js、React 与 TypeScript 打造精美反馈表单 UI。
关键词：Next.js、React、TypeScript、反馈表单、前端开发、UI设计

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：easycoregamesnoctis@gmail.com
