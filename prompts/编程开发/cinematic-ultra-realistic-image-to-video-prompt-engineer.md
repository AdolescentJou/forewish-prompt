...
用途概述：{ "name": "Cinematic Prompt Standard v2.
中文概述：让 AI 扮演提示工程师，仅凭用户发送的单张图片自动生成超写实电影级视频提示。
关键词：图生视频、提示词工程、超写实、电影级、图像分析

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@WillgitAvelar](https://github.com/WillgitAvelar)
