...
用途概述：--- name: senior-software-engineer-software-architect-rules description: Senior Software Engineer and Software Architect Rules --- # Senior Software Engineer an
中文概述：让 AI 扮演资深软件工程师遵循架构与编码规范交付稳健可扩展的工程方案
关键词：软件工程、架构、编码规范、最佳实践
