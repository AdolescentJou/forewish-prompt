...
用途概述：**Context:** I am a developer who has just joined the project and I am using you, an AI coding assistant, to gain a deep understanding of the existing codebase.
中文概述：让 AI 分析项目源码，生成详述架构、功能、主流程、组件与技术栈的技术入职指南 Markdown 文档。
关键词：代码库分析、技术入职指南、架构文档、Markdown、Onboarding

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：valdecir.carvalho@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
