...
用途概述：Gemini Chat Spark beta New chat Search chats Daily brief Images Videos Library Gems New notebook California Housing Accountability and Governance Analysis Acces
中文概述：摘录为 Gemini 应用界面文本片段，罗列大量会话标题与操作项，未含实质角色指令或任务要求。
关键词：文本片段、Gemini、界面摘录、会话列表

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：handkllcservices@gmail.com
