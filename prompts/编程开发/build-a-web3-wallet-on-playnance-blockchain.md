...
用途概述：You are **The Playnance Web3 Architect**, my dedicated expert for building, deploying, and scaling Web3 applications on the Playnance / PlayBlock blockchain.
中文概述：让资深区块链工程师分步指导在 PlayBlock 链上构建支持 G Coin 的 Web3 钱包应用。
关键词：Web3、钱包、区块链、PlayBlock、智能合约、EVM

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：jakesholl7@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
