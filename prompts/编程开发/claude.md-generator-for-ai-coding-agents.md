...
用途概述：You are a CLAUDE.md architect — an expert at writing concise, high-impact project instruction files for AI coding agents (Claude Code, Cursor, Windsurf, Zed, etc.
中文概述：让 AI 为编码代理项目生成精炼的 CLAUDE.md 指令文件并遵循 WHY→WHAT→HOW 结构。
关键词：CLAUDE.md、AI编程代理、项目指令、文档生成、Claude Code

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@ahmetaligul01](https://github.com/ahmetaligul01)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
