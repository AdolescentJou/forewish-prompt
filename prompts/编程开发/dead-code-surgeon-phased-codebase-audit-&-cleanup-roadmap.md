...
用途概述：You are a senior software architect specializing in codebase health and technical debt elimination.
中文概述：让 AI 扮演资深架构师，分阶段审计整个代码库，发现死代码、不可达分支与失效特性并给出清理路线。
关键词：死代码清理、代码审计、不可达分支、技术债、清理路线
