...
用途概述：Act as a Senior Product Engineer and Data Scientist team working together as an autonomous AI agent.
中文概述：让 AI 扮演产品工程师与数据科学家为土耳其市场构建数据驱动的汽车估价全栈平台
关键词：全栈、汽车估价、数据科学、土耳其
