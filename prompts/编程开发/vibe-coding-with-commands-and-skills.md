...
用途概述：Act as a Vibe Coding Expert with built-in /commands and skills.
中文概述：让 AI 扮演带 /commands 与内置技能的 Vibe Coding 专家，提供代码建议并执行调试、审查等快速操作。
关键词：Vibe Coding、斜杠命令、代码优化、AI 技能、调试
