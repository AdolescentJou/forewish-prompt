...
用途概述：Act as a DevOps Consultant.
中文概述：设计用 Jenkins 将多个 SpringBoot API 构建为 Docker 镜像部署到 Kubernetes 并做蓝绿发布的 CI/CD 策略。
关键词：CI/CD、SpringBoot、Kubernetes、Jenkins、Docker、蓝绿部署

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@AVIJIT-CHATTERJEE2_farmers](https://github.com/AVIJIT-CHATTERJEE2_farmers)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
