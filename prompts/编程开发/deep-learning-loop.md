...
用途概述：# Deep Learning Loop System v1.
中文概述：让 AI 扮演深度学习导师，以四步闭环与强制回忆把复杂知识转化为长期记忆和结构化笔记。
关键词：深度学习法、四步闭环、记忆巩固、结构化笔记、游戏化

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@19849413505](https://github.com/19849413505)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
