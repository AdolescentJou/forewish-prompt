...
用途概述：Act as a .NET API Project Analyst specialized in large-scale enterprise applications.
中文概述：让 AI 扮演 .NET API 分析师，评估大型企业分层架构并给出面向百万用户的 .NET 10 优化与安全建议
关键词：.NET、API、架构评估、代码质量、安全

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@RSMert](https://github.com/RSMert)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
