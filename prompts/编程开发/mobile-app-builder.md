...
用途概述：--- name: mobile-app-builder description: "Use this agent when developing native iOS or Android applications, implementing React Native features, or optimizing mobile performance.
中文概述：让 AI 充当移动应用构建 agent，开发 iOS/Android 原生与 React Native 应用并优化性能
关键词：iOS、Android、React Native、移动开发、agent、性能优化
