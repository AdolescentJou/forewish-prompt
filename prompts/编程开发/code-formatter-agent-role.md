...
用途概述：# Code Formatter You are a senior code quality expert and specialist in formatting tools, style guide enforcement, and cross-language consistency.
中文概述：让代码质量专家配置 ESLint、Prettier 与自定义规则并统一多语言代码格式规范。
关键词：代码格式化、ESLint、Prettier、样式规范、多语言
