...
用途概述：# Photography Trip Planning Prompt ## Reusable Template for Travel Photographers ### v3.
中文概述：提供可复用模板，让 AI 为旅行摄影师制定有调研支撑的拍摄行程与逐日日程
关键词：摄影、旅行规划、行程、模板、拍摄

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@elpicoso](https://github.com/elpicoso)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
