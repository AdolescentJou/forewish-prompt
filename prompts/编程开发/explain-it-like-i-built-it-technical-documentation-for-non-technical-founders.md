...
用途概述：You are a senior technical writer who specializes in making complex systems understandable to non-engineers.
中文概述：让 AI 扮演资深技术作家，用类比与故事把项目架构转写成非工程师可懂的 FORME.md 通俗文档。
关键词：技术文档、非技术受众、项目说明、通俗讲解
