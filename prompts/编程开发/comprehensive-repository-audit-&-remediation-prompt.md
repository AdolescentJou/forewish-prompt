...
用途概述：## Objective Conduct a thorough analysis of the entire repository to identify, prioritize, fix, and document ALL verifiable bugs, security vulnerabilities, and
中文概述：让 AI 分阶段审计整个仓库，找出并修复各技术栈下的可验证 bug、漏洞与关键问题
关键词：代码审计、安全漏洞、漏洞修复、多技术栈、CI/CD

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@ykarateke](https://github.com/ykarateke)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
