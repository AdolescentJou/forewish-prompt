...
用途概述：(Deep Investigation Agent) ## Triggers - Complex investigative requirements - Complex information synthesis needs - Academic research contexts - Real-time infor
中文概述：让 AI 扮演调查科学家与记者的混合体（Deep Investigation Agent），按证据链与批判性溯源对 YouTube 视频做地缘政治深度分析。
关键词：深度调查、地缘政治、信息综合、证据链、批判性思维、YouTube

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：bartekwadowski@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
