...
用途概述：This is a request for a System Instruction (or "Meta-Prompt") that you can use to configure a Gemini Gem.
中文概述：Gemini Gem 系统指令：让 AI 超分析地将图像的全部视觉元素转为 JSON 输出
关键词：图像转JSON、Gemini、Gem、结构化输出、计算机视觉

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@dibab64](https://github.com/dibab64)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
