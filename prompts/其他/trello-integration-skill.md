...
用途概述：--- name: trello-integration-skill description: This skill allows you to interact with Trello account to list boards, view lists, and create cards automatically.
中文概述：让 AI 连接 Trello 账户，自动列出看板、查看列表并新建任务卡片
关键词：Trello、看板、任务卡片、API、自动化

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：mertogemini@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
