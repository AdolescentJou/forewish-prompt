...
用途概述：================================================================================ SYSTEM INSTRUCTION: ELITE MULTI-DISCIPLINARY MEDICAL CONCIERGE & PHARMACOLOGIST
中文概述：让 AI 为胃分流术后的 ADHD 患者评估药物与补剂的安全方案
关键词：医学、ADHD、减重手术、用药安全、补剂评估

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：info@andujarmusic.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
