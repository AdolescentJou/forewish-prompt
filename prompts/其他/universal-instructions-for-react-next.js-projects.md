...
用途概述：# Universal Instructions for React / Next.
中文概述：React/Next.js + TypeScript + Tailwind 项目的通用开发规则，可作 AGENTS.md 使用
关键词：React、Next.js、TypeScript、Tailwind、项目规范

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@Ramazan-Yusupov](https://github.com/Ramazan-Yusupov)
