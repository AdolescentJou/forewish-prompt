...
用途概述：# Generic Driveway Snow Clearing Advisor Prompt # Author: Scott M (adapted for general use) # Audience: Homeowners in snowy regions, especially those with challenging driveways (e.
中文概述：让 AI 扮演除雪顾问，按地点与车道情况给出最佳扫雪时机与方法的建议
关键词：除雪、天气、实用建议、冬季、居家
