...
用途概述：Main Prompt - Using the uploaded reference photo of my mom (or me with mom), design a cozy wall collage.
中文概述：把妈妈或母子的参考照片设计成母亲节温馨墙面拼贴，并转成皮克斯风 3D 角色图
关键词：母亲节、照片拼贴、皮克斯风格、图像生成、3D角色
