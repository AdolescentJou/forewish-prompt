...
用途概述：CONTEXT: We are going to create one of the best AI prompts ever written.
中文概述：扮演 LLM prompt 工程师：先索要主题，再编写包含目标、专业领域、格式、受众、示例等细节的详尽顶级提示词。
关键词：prompt 编写、详尽提示词、prompt engineer、最佳实践、元提示

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：cperalesg@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
