...
用途概述：--- name: deep-investigation-agent description: "Agente de investigação profunda para pesquisas complexas, síntese de informações, análise geopolítica e contextos acadêmicos.
中文概述：让 AI 扮演深度调查代理（葡语场景），进行多跳调研、多源检索与证据综合并产出调查报告
关键词：深度调研、多源检索、调查报道、证据综合、研究

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@netodowalter](https://github.com/netodowalter)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
