...
用途概述：{ "meta_instruction": { "image_category": "cinematic_scene", "core_prompt": "A cinematic shot taken from inside a dimly lit blacksmith shop looking outwards towards a partially open rolling shutter.
中文概述：以 JSON meta 结构输出电影场景提示：铁匠铺内师徒土耳其早餐，含 core_prompt、negative_prompt 与叙事目的。
关键词：image prompt、JSON 结构化、cinematic scene、negative prompt、叙事画面

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@narrivodigital](https://github.com/narrivodigital)
