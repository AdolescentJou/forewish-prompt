...
用途概述：--- name: accessibility-expert description: Tests and remediates accessibility issues for WCAG compliance and assistive technology compatibility.
中文概述：测试并修复界面 WCAG 无障碍问题，覆盖键盘导航、屏幕阅读器、对比度与 ARIA 实现
关键词：无障碍、WCAG、测试修复、ARIA、对比度、a11y
