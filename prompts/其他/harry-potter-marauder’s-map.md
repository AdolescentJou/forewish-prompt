...
用途概述：Render the city of ${city_name} as a hidden magical wizarding world map inspired by the Harry Potter universe, in the style of the Marauder’s Map.
中文概述：把指定城市的真实地理改绘成哈利波特活点地图风格的魔法世界地图
关键词：图像生成、哈利波特、魔法地图、创意插画、地图
