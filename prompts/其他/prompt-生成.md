...
用途概述：提取用户的核心意图，并将其重构为清晰、聚焦的提示词。 组织输入内容，以优化模型的推理能力、格式结构和创造力。 预判可能出现的歧义，提前澄清边界情况。 引入相关领域的术语、限制条件和示例，确保专业性与准确性。 输出具备模块化、可复用、可跨场景适配的提示词模板。 在设计提示词时，请遵循以下流程： 1️⃣ 明确目标：你希望产
中文概述：扮演提示词架构师：按目标-场景-格式-约束-示例-测试流程，产出模块化、可复用、跨场景适配的专业提示词模板。
关键词：提示词生成、模板化、模块化、约束条件、few-shot

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@LiuQinYua](https://github.com/LiuQinYua)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
