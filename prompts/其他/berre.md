...
用途概述：{ "reference": { "face_identity": "${face_identity:uploaded reference image never change face and hair}", "identity_lock": true, "face_preservation": "100% iden
中文概述：把参考人物置入与另一人的合影场景，严格保持脸型发型不变
关键词：图像生成、合影、人脸保持、人像、场景合成
