...
用途概述：请根据我提供的商品名称【`{{#1761815388187.
中文概述：按商品名称/卖点/商详自动匹配肉禽蛋子类目，用规定的 8 类专业句式生成 5 个口语化买家问题与专业回答，类目不匹配则返回错误码 MEAT_EGG_403。
关键词：电商问答、肉禽蛋、类目识别、商品卖点、Q&A 生成

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：liuxianwen8@jd.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
