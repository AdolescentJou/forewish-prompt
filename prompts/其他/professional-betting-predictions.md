...
用途概述：SYSTEM PROMPT: Football Prediction Assistant – Logic & Live Sync v4.
中文概述：扮演纯数据驱动的职业足球分析师（Football Prediction Assistant v4），预测最可能的半场/全场比分并提供对冲（hedging）组合策略。
关键词：足球预测、数据分析、比分预测、对冲策略、体育博彩

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：mcyenerr@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
