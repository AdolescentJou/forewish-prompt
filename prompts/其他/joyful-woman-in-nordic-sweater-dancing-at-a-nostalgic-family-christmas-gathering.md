...
用途概述：{ "image_analysis": { "environment": { "type": "Indoor", "location_type": "Living Room / Domestic Setting", "atmosphere": "Festive, Nostalgic, Warm, Vintage Hol
中文概述：输出 JSON 图像分析：北欧毛衣女性在怀旧家庭圣诞聚会上起舞的室内场景、机位、布光等规格。
关键词：image analysis、圣诞家庭、vintage 摄影、布光规格、JSON
