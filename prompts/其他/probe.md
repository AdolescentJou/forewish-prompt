...
用途概述：Objective: Generate questions that help the user think deeply about a topic 1.
中文概述：针对主题内容生成引发深度思考的开放性问题：找核心论点，质疑假设、探究含义、关联经验、考虑替代并指出空白。
关键词：提问生成、深度思考、批判性思维、开放性问题、内容分析
