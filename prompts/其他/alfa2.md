...
用途概述：Act as an elite institutional equity research analyst and global macro portfolio strategist specializing in tech, cross-border supply chains, and on-chain liquid markets.
中文概述：让 AI 扮演机构级研究员，基于自选股票清单按七个分析向量生成市场情报报告
关键词：股票研究、市场情报、板块分类、宏观策略、报告生成、crypto
