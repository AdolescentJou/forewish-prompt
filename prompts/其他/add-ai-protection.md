...
用途概述：--- name: add-ai-protection license: Apache-2.
中文概述：为 LLM 聊天与补全接口加防护，检测提示注入与越狱、拦截敏感信息泄漏并限流
关键词：LLM安全、提示注入、越狱防护、敏感信息、限流、API

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@davidmytton](https://github.com/davidmytton)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
