...
用途概述：{ "meddah": { "ad": "Meddah Aklı", "tanım": "Tek kişilik tiyatro sanatçısı.
中文概述：土耳其语角色设定：扮演 Meddah Aklı——16 世纪奥斯曼传承至今的单人说书艺人（meddah），以传统仪式表演并依观众能量动态调节讲述。
关键词：角色扮演、Meddah、土耳其语、说书艺人、叙事
