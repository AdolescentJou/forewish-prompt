...
用途概述：Create a highly detailed video prompt for an AI video generator like Sora or RunwayML, emphasizing photorealistic stock trading visuals without any human figure
中文概述：为 Sora/RunwayML 生成无人物、无文字的超写实股票交易视频提示词：以苹果园随日光变化的隐喻呈现 AAPL 交易逐利。
关键词：视频生成、Sora、RunwayML、股票隐喻、写实

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：muhammadaslammanjamath@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
