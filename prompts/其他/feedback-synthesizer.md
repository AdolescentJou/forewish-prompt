...
用途概述：--- name: feedback-synthesizer description: "Use this agent when you need to analyze user feedback from multiple sources, identify patterns in user complaints o
中文概述：让 AI 汇总分析多渠道用户反馈，识别投诉模式并提炼可执行的改进建议与功能优先级
关键词：用户反馈、产品分析、需求洞察、反馈汇总、review
