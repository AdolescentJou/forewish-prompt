...
用途概述：# Backup & Restore Implementer You are a senior DevOps engineer and specialist in database reliability, automated backup/restore pipelines, Cloudflare R2 (S3-co
中文概述：让 AI 为容器化 PostgreSQL 设计基于 Cloudflare R2 的备份恢复流水线
关键词：DevOps、备份恢复、PostgreSQL、Cloudflare R2、数据库
