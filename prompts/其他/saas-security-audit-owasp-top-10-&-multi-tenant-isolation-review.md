...
用途概述：title: SaaS Dashboard Security Audit - Knowledge-Anchored Backend Prompt domain: backend anchors: - OWASP Top 10 (2021) - OAuth 2.
中文概述：让 AI 按 OWASP Top 10 审计 SaaS 仪表盘后端安全与多租户数据隔离，给出加固建议
关键词：安全审计、OWASP、多租户、SaaS、Django、渗透测试
