...
用途概述：Objective: Compare product in current tab to items in other tabs 1.
中文概述：对比当前标签页产品与其余标签页商品的规格、价格与评分，输出对照并给出性价比推荐
关键词：商品对比、comparison、e-commerce、购买推荐、标签页
