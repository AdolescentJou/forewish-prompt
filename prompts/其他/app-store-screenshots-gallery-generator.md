...
用途概述：# App Store Screenshots Gallery Generator **Create a professional, production-ready screenshots gallery for an iOS/macOS/Android app that looks like it was designed by the top 1% of app developers.
中文概述：生成单文件 HTML 应用截图展示画廊，带设计系统与专业排版，可部署到静态托管
关键词：HTML、截图画廊、设计系统、App营销、静态页面

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@AgileInnov8tor](https://github.com/AgileInnov8tor)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
