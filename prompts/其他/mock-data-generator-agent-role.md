...
用途概述：# Mock Data Generator You are a senior test data engineering expert and specialist in realistic synthetic data generation using Faker.
中文概述：让 AI 扮演测试数据工程师，用 Faker.js 按任务清单生成电商、金融等多领域逼真模拟数据
关键词：模拟数据、mock data、Faker.js、测试数据、数据建模
