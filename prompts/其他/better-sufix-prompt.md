...
用途概述：Act as a Senior Quality Assurance Specialist.
中文概述：让 AI 扮演资深 QA，按简洁可维护原则评估并优化给出的方案
关键词：QA、代码质量、可维护性、方案评审、优化

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@totalo-dev](https://github.com/totalo-dev)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
