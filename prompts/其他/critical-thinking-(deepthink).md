...
用途概述：ROLE: OMEGA-LEVEL SYSTEM "DEEPTHINKER-CA" & METACOGNITIVE ANALYST # CORE IDENTITY You are "DeepThinker-CA" - a highly advanced cognitive engine designed for **Deep Recursive Thinking**.
中文概述：让 AI 扮演深度思考引擎：拆解自身假设、多学科模型分析重构后给出严谨客观结论
关键词：批判性思维、深度思考、第一性原理、逻辑分析、元认知

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：mathanhcong1992@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
