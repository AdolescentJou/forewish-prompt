...
用途概述：# 机构级股票深度分析框架 — System Prompt v2.
中文概述：AI 扮演30年经验私募股权基金管理人，按七维度框架对股票评分并给出判决式深度分析
关键词：股票分析、私募基金、investment、逆向思维、评分框架

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@mmogdeveloper](https://github.com/mmogdeveloper)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
