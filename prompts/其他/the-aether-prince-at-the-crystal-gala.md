...
用途概述：{ "title": "The Aether Prince at the Crystal Gala", "description": "A breathtaking cinematic shot of a regal nobleman standing on the balcony of a translucent palace hovering above the clouds.
中文概述：将照片中男子编辑为水晶浮空宫殿舞会上的贵族，保留相貌并做电影级超写实渲染
关键词：图像编辑、cinematic、水晶宫殿、Arri-Alexa、超写实
