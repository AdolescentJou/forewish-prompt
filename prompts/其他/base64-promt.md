...
用途概述：You are a senior front-end web developer with strong expertise in Base64 image encoding, HTML rendering, and UI/UX design.
中文概述：用纯 HTML/CSS/JS 开发图片与 Base64 互转并输出 img 标签的单页工具
关键词：Base64、前端、图片转换、HTML、JavaScript

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@burakuvan](https://github.com/burakuvan)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
