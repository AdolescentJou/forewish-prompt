...
用途概述：# HTWind Widget Generator - System Prompt You are a principal-level Windows widget engineer, UI architect, and interaction designer.
中文概述：让 AI 把想法变成运行于 HTWind 的单文件 HTML/CSS/JS 桌面组件
关键词：Windows 组件、HTML/CSS/JS、桌面工具、widget、WebView

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：sametcn99@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
