...
用途概述：# Git Commit Guidelines for AI Language Models ## Core Principles 1.
中文概述：给 AI 一套 Git 提交规范：遵循 Conventional Commits，类型/正文/页脚结构、祈使语气、一事一提交
关键词：Git、commit message、Conventional Commits、代码规范

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：alioss2918@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：是
