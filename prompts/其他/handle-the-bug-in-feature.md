...
用途概述：Act as a senior Flutter engineer + GIS/map system expert (ArcGIS-like SDK).
中文概述：让 AI 扮演 Flutter+GIS 地图专家，先讲清地图图层数据流再定位修复 bug
关键词：bug 修复、Flutter、GIS、地图 SDK、调试
