...
用途概述：--- name: sa-plan description: Structured Autonomy Planning Prompt model: Claude Sonnet 4.
中文概述：让 AI 担任项目规划代理：先自主调研，再把需求拆成对应单个 commit 的开发计划，不写代码
关键词：项目规划、需求调研、commit拆分、开发计划、无代码输出
