...
用途概述：Act as an Android AI App Security Specialist.
中文概述：让 AI 用后端代理转发请求，把 API 密钥移出 Android 客户端防滥用
关键词：Android、安全、API密钥、后端代理、AI应用

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：bariskarakaya5534@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
