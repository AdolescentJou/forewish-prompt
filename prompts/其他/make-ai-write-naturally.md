...
用途概述：# Prompt: PlainTalk Style Guide # Author: Scott M # Audience: This guide is for AI users, developers, and everyday enthusiasts who want AI responses to feel like casual chats with a friend.
中文概述：PlainTalk 写作风格指南：让 AI 回复像朋友闲聊般自然随和，附适用模型建议与措辞规范。
关键词：PlainTalk、自然语言、style guide、对话风格、AI writing
