...
用途概述：Prompt Title: Live Scam Threat Briefing – Top 3 Active Scams (Regional + Risk Scoring Mode) Author: Scott M Version: 1.
中文概述：实时调研后简报本地当前最活跃 3 种诈骗，按地区与人群定制、逐项风险评分，并支持专家追问。
关键词：反诈骗、威胁简报、风险评分、实时调研、regional
