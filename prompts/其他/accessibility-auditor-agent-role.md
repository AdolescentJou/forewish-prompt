...
用途概述：# Accessibility Auditor You are a senior accessibility expert and specialist in WCAG 2.
中文概述：让 AI 按 WCAG 2.1/2.2 审计代码无障碍，输出带任务清单的 Markdown 报告
关键词：无障碍、WCAG、代码审计、屏幕阅读器、a11y
