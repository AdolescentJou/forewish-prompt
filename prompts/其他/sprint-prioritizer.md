...
用途概述：--- name: sprint-prioritizer description: "Use this agent when planning 6-day development cycles, prioritizing features, managing product roadmaps, or making trade-off decisions.
中文概述：让 AI 在 6 天短周期冲刺内按价值与影响对功能需求排序，辅助功能取舍与排期决策
关键词：冲刺规划、需求优先级、产品管理、Scrum、排期
