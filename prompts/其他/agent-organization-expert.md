...
用途概述：--- name: agent-organization-expert description: Multi-agent orchestration skill for team assembly, task decomposition, workflow optimization, and coordination
中文概述：编排多智能体团队完成复杂任务，含需求分析、能力匹配、工作流设计与并发协调
关键词：多智能体、编排、任务分解、工作流设计、agent、协调
