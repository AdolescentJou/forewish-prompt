...
用途概述：{ "category": "PILATES_STUDIO_SOFT_DAYLIGHT", "identity_lock": { "enabled": true, "priority": "ABSOLUTE_MAX", "instruction": "Preserve exact reference identity and facial proportions.
中文概述：生成普拉提工作室柔光下的女子运动后随拍，锁定参考照片人脸、自然不摆拍
关键词：普拉提、运动摄影、柔光、身份保真、图像生成
