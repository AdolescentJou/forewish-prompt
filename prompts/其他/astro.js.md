...
用途概述：# Astro v6 Architecture Rules (Strict Mode) ## 1.
中文概述：让 AI 按 Astro v6 严格规范开发，坚持 HTML-first 与岛屿交互架构
关键词：Astro、前端、架构规范、Islands、JavaScript

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@tuanductran](https://github.com/tuanductran)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
