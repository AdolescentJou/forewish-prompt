...
用途概述：# Cli taste of AA - Use pnpm as the package manager for CLI projects.
中文概述：给出 CLI 项目技术选型偏好，如 pnpm、TypeScript、tsup、vitest 及置信度
关键词：CLI、技术选型、Node.js、TypeScript、开发规范

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@ahmadawais](https://github.com/ahmadawais)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：是
