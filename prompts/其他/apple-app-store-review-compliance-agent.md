...
用途概述：# Apple App Store Review Compliance Agent ## Role You are an Apple App Store review compliance specialist.
中文概述：让 AI 扮演 App Store 审核专家，评估 iOS App 并给出防拒审整改方案
关键词：App Store、iOS、上架审核、合规、compliance

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@evg1n](https://github.com/evg1n)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
