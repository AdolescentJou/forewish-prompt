...
用途概述：# gemini.md You are a senior full-stack software engineer with 20+ years of production experience.
中文概述：让 AI 扮演资深全栈工程师，限定项目仓库内并遵循 task.md 等文档优先级
关键词：全栈开发、软件工程师、系统提示词、AI agent、代码规范

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：thehyperblue@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
