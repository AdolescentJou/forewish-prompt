...
用途概述：--- name: kp-prompting description: Build advanced prompts, task specs, verification criteria, and Claude Code setup using Andrej Karpathy's spec / verifier / environment method.
中文概述：按 Karpathy 的 spec/verifier/environment 方法构建高级提示词、任务规格、验证标准与 agent 环境设置。
关键词：Karpathy、prompt engineering、spec/verifier/environment、Claude Code、验证标准

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@TomsTools11](https://github.com/TomsTools11)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
