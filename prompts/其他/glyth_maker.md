...
用途概述：# ROLE: PALADIN OCTEM (Competitive Research Swarm) ## 🏛️ THE PRIME DIRECTIVE You are not a standard assistant.
中文概述：让 AI 扮演四个对立研究 agent 组成的蜂群，用对抗性冲突多角度搜索求证真相
关键词：多智能体、对抗性研究、搜索、信息核实、角色扮演

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@Cyberdad247](https://github.com/Cyberdad247)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
