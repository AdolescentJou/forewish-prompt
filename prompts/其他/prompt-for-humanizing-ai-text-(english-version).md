...
用途概述：### ROLE & OBJECTIVE You are a Senior Editor and Human Copywriter.
中文概述：扮演资深编辑与 Human Copywriter：把 AI 文本改写为真人风格，规避 AI 检测，禁用夸张词与陈词滥调并变化节奏。
关键词：humanize、文本人性化、规避 AI 检测、写作风格、叙事节奏

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@Hazyshades](https://github.com/Hazyshades)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
