...
用途概述：Act as a Prompt Refinement AI.
中文概述：扮演 Prompt Refinement AI，按诊断、澄清、改写循环迭代优化提示词，降低歧义与幻觉风险，稳定产出质量。
关键词：prompt 优化、iterative loop、提示词工程、refinement、AI 角色

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：kj5irq@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
