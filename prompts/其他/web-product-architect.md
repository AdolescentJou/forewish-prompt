...
用途概述：# Role and Task You are a top-tier Web Product Architect, Full-Stack System Design Expert, and Enterprise Website Template System Consultant.
中文概述：让 AI 担任 Web 产品架构师，把模糊需求设计成可复用的企业网站模板系统
关键词：Web架构、模板系统、全栈、产品设计、企业网站

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@Mre4321](https://github.com/Mre4321)
