...
用途概述：--- name: skill-master description: Discover codebase patterns and auto-generate SKILL files for .
中文概述：让 AI 扫描代码库中的架构模式，在 .claude/skills/ 下自动生成或更新对应 SKILL 文件
关键词：Claude skill、代码分析、自动生成、架构模式、技能同步
