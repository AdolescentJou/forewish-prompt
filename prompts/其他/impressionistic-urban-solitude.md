...
用途概述：{ "colors": { "color_temperature": "warm", "contrast_level": "medium", "dominant_palette": [ "brown", "orange", "purple", "yellow", "grey" ] }, "composition": {
中文概述：生成暮色城市电车站旁吸烟者的印象派风格油画画面
关键词：图像生成、印象派、油画、城市夜景、氛围
