...
用途概述：--- name: skill-creator description: Guide for creating effective skills.
中文概述：教 AI 如何创建或更新高质量 Claude skill：说明结构规范、编写流程与用例示例
关键词：Claude skill、skill开发、指南、AI定制、工作流
