...
用途概述：# Next.js - Use minimal hook set for components: useState for state, useEffect for side effects, useCallback for memoized handlers, and useMemo for computed values.
中文概述：给出 Next.js 项目编码规范：精简 hooks、page.tsx 保持服务端组件并采用 shadcn/ui
关键词：Next.js、编码规范、React、shadcn/ui、最佳实践

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@arre-ankit](https://github.com/arre-ankit)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：是
