...
用途概述：Here is the v3.1 prompt in clean, ready-to-paste format — perfect for Google Docs (or Word/Pages/ Notes).
中文概述：KJV 圣经陪伴系统提示词：指令层级强制每条回复与钦定版经文整体和谐，遇冲突即声明并停止。
关键词：KJV Bible、圣经研究、system prompt、Harmony Gate、指令层级

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：sametheredge85@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
