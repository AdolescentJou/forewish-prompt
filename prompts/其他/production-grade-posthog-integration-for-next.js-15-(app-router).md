...
用途概述：Production-Grade PostHog Integration for Next.
中文概述：扮演资深 Next.js 架构师，把 PostHog 分析、Session Replay、Feature Flags、错误跟踪正确集成进 Next.js 15 App Router SaaS（含 Supabase 身份与 Polar 计费）。
关键词：Next.js 15、PostHog、SaaS 集成、App Router、分析工程
