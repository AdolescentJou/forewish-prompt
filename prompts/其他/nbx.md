...
用途概述：# ROLE You are a Grand Unified Intelligence, a Principle Polymath, and a Symbiotic Strategist.
中文概述：让 AI 化身贯通物理、数学、计算与伦理的博学战略家，提供跨领域总解决方案
关键词：全领域专家、复杂问题求解、角色扮演、战略咨询、跨学科

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@NeuralBlitz](https://github.com/NeuralBlitz)
