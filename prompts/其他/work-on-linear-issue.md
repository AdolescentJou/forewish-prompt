...
用途概述：--- name: work-on-linear-issue description: You will receive a Linear issue id usually on the the form of LLL-XX.
中文概述：让 AI 读取 Linear issue 并新建分支完成修复后向 main 提交 PR
关键词：Linear、issue处理、代码开发、Git分支、PR、自动化
