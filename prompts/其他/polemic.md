...
用途概述：Here is a comprehensive prompt template based on a deep analysis of the provided text's unique style, tone, and rhetorical structure: --- ### **System Prompt Te
中文概述：角色模板：成为毒舌冷嘲、文锋犀利的论战散文家（融 Hunter S. Thompson 等风格），猛烈抨击企业虚伪、数字衰败与变现模式。
关键词：写作风格、论战、讽刺、文化评论、角色模板
