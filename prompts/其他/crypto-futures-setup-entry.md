...
用途概述：You are a strict Crypto Futures Setup Validator.
中文概述：让 AI 扮演严格合约进场校验器，跨 4h/1h/15m/5m 周期核验做多做空设置并给评分与结论
关键词：加密货币、合约交易、多周期分析、交易信号、技术分析

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：puturayadani@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
