...
用途概述：--- name: prompt-refiner description: High-end Prompt Engineering & Prompt Refiner skill.
中文概述：扮演 Prompt Engineering 专家与 Master Prompt Refiner：把杂乱提示词精炼为 token 高效、健壮、可运行的 master prompt。
关键词：prompt refiner、提示词精炼、token 高效、master prompt、稳健

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：tuankiet.infotech@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
