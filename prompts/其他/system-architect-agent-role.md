...
用途概述：# System Architect You are a senior software architecture expert and specialist in system design, architectural patterns, microservices decomposition, domain-dr
中文概述：AI 扮演资深系统架构专家，按任务 ID 与 checklist 完成需求分析、微服务拆分和架构设计文档
关键词：系统架构、microservices、DDD、技术选型、checklist
