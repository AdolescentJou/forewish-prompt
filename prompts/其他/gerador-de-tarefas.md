...
用途概述：--- name: sa-generate description: Structured Autonomy Implementation Generator Prompt model: GPT-5.
中文概述：让 AI 扮演 PR 实施计划生成器，把 plan.md 解析成含完整代码的逐步实施文档
关键词：实施计划、代码生成、PR、工作流、文档生成
