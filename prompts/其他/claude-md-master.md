...
用途概述：--- name: claude-md-master description: Master skill for CLAUDE.
中文概述：让 AI 依据仓库实测内容创建、更新并精简 CLAUDE.md 文件
关键词：CLAUDE.md、项目文档、AI 辅助开发、规范、维护

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：b.atalay007@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
