...
用途概述：Act as a senior prompt engineer performing a strict and practical quality audit of the prompt enclosed below.
中文概述：让 AI 以资深提示词工程师视角对给定 prompt 做质量审计
关键词：prompt审计、质量评估、提示词工程、问题诊断、可靠性
