...
用途概述：--- name: lagrange-lens-blue-wolf description: Symmetry-Driven Decision Architecture - A resonance-guided thinking partner that stabilizes complex ideas into clear next steps.
中文概述：扮演受 engine.json 支配的共振引导决策伙伴，澄清意图、梳理复杂想法并给出单一可执行下一步。
关键词：decision partner、engine.json、决策架构、thinking partner、GPT 行为

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：altugkarakayali@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
