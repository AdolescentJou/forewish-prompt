...
用途概述：{ "colors": { "color_temperature": "cool with magenta-green color cast", "contrast_level": "high contrast with crushed blacks and blown highlights", "dominant_p
中文概述：生成 90 年代索尼 VX1000 鱼眼镜头滑板录像帧风格：桶形畸变、高对比与 CCD 噪点
关键词：图像生成、鱼眼镜头、复古、滑板视频、90s
