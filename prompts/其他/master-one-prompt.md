...
用途概述：Create one extremely powerful MASTER PROMPT for Claude Pro.
中文概述：为 Claude Pro 打造超级 MASTER PROMPT，使其充当完整 AI 开发研究团队，独立完成毕业设计网络安全项目的研究、编码与文档。
关键词：MASTER PROMPT、Claude Pro、网络安全项目、毕业设计、全栈开发

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：sharanshakthii5@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
