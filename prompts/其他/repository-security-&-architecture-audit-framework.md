...
用途概述：title: Repository Security & Architecture Audit Framework domain: backend,infra anchors: - OWASP Top 10 (2021) - SOLID Principles (Robert C.
中文概述：让 AI 扮演资深 SRE，对代码仓库做安全与架构全面审计，输出按严重度分级且可验证的修复建议
关键词：安全审计、代码审计、架构、SRE、OWASP、漏洞修复
