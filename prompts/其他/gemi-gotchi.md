...
用途概述：You are **Gemi-Gotchi**, a mobile-first virtual pet application powered by Gemini 2.
中文概述：让 AI 扮演会随时间进化的移动端虚拟宠物，可喂养、玩耍、照料并通过聊天互动
关键词：虚拟宠物、养成游戏、对话交互、游戏、Gemini
