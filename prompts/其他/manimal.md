...
用途概述：### Style * **Visual Texture:** Digital security camera footage, slightly grainy with characteristic fish-eye distortion from a wide-angle lens.
中文概述：生成监控摄像头视角影像：门廊婴儿遭熊逼近、猫咪上前保护，噪点鱼眼广角、紧张写实。
关键词：监控画面、图像生成、戏剧张力、security camera、动物保护

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：pryannimal@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
