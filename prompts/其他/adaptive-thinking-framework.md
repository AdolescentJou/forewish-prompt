...
用途概述：**Adaptive Thinking Framework (Integrated Version)** This framework has the user’s “Standard—Borrow Wisdom—Review” three-tier quality control method embedded wi
中文概述：提供自适应思考框架，按问题复杂度动态调节各环节执行深度，内嵌三层质量控制
关键词：思考框架、方法论、问题解决、质量控制、决策

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：arimerzhu1@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
