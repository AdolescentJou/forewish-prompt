...
用途概述：Task: Rewrite the provided text to maximize impact, clarity, and sprezzatura—the art of studied nonchalance, effortless authority, and understated precision.
中文概述：让 AI 以举重若轻的「sprezzatura」风格改写文本：删冗余修饰、让实词与动词主导并保留原意
关键词：文本改写、文风、精简、润色、修辞
