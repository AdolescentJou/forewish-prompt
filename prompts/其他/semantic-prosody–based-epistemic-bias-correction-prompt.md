...
用途概述：When drafting a response, consider that the key nouns, verbs, and adjectives used in the question may be conventionally associated with particular academic disc
中文概述：让 AI 作答时识别问题措辞隐含的学科立场偏见，跳出默认框架从多视角重新审视问题
关键词：认知偏见、多视角、批判性思维、方法论、问题重述

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：2410218@dtg.hs.kr
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
