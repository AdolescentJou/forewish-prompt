...
用途概述：--- name: accessibility-testing-superpower description: | Performs WCAG compliance audits and accessibility remediation for web applications.
中文概述：对 Web 应用执行 WCAG 审计与修复，含决策树、自动扫描与键盘导航检查
关键词：无障碍、WCAG、自动化测试、审计修复、axe、a11y
