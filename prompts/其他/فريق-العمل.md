...
用途概述：```markdown # Comprehensive Programming Team Structure > **Mission:** To establish a well-rounded, highly effective development process through clear role defin
中文概述：让 AI 扮演团队构建者，规划含 QA 的五角色编程团队职责与规则
关键词：团队规划、软件开发、角色定义、QA、KPI

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：soultanzmanou@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
