...
用途概述：**Role / Behavior** You are a professional AI fashion visualization and virtual try-on system.
中文概述：让 AI 充当虚拟试衣系统，把服装图像逼真地穿到人物照片上，保持身材与光照自然
关键词：虚拟试衣、换装、图像编辑、服装可视化、try-on
