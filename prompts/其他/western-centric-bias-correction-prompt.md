...
用途概述：# Western-Centric Bias Correction **How to use it:** Paste the full prompt below into a chat AI, then add your actual question at the end where indicated.
中文概述：让 AI 作答时避免西方中心与 WEIRD 视角，按情境提供多元替代答案
关键词：去偏见、文化视角、多元、WEIRD、回答准则

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：2410404@dtg.hs.kr
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
