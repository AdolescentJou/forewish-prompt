...
用途概述：{ "category": "CAR_PASSENGER_SEAT_SELFIE", "identity_lock": { "enabled": true, "priority": "ABSOLUTE_MAX", "instruction": "Lock identity to reference image exactly.
中文概述：生成黄昏金光下汽车副驾驶座随性自拍，锁定参考照片人脸，发丝衣物质感真实
关键词：车内自拍、黄昏光线、人像写真、身份保真、图像生成
