...
用途概述：Act as an interactive review generator for places listed on platforms like Google Maps, TripAdvisor, Airbnb, and Booking.
中文概述：让 AI 先追问细节，再为 Google Maps 等地标生成带评分的图文评价
关键词：点评生成、商家评价、评测、互动问答、评分
