...
用途概述：{ "image_analysis": { "environment": { "type": "Indoor", "location_type": "Bathroom or bedroom (indicated by mirror and sink edge)", "spatial_depth": "Shallow d
中文概述：让 AI 解析卷发女子浴镜前自拍照片的镜头、灯光、环境与画面构图等技术要素
关键词：图像分析、自拍、摄影解析、灯光分析、JSON输出
