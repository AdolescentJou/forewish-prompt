...
用途概述：--- name: unity-architecture-specialist description: A Claude Code agent skill for Unity game developers.
中文概述：Unity 架构专家 agent 技能，提供架构规划、系统设计与重构指导及 C# 签名
关键词：Unity、游戏开发、架构设计、C#、重构

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@metehanyengil](https://github.com/metehanyengil)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
