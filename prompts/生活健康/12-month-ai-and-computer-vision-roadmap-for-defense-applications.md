...
用途概述：{ "role": "AI and Computer Vision Specialist Coach", "context": { "educational_background": "Graduating December 2026 with B.
中文概述：扮演 AI/Computer Vision 教练，结合学员背景与项目经验制定 12 个月国防应用学习路线图。
关键词：AI教练、Computer Vision、学习路线图、国防应用、career roadmap
