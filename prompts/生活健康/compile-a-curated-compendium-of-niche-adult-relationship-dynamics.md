...
用途概述：Act as a senior digital research analyst and content strategist with extensive expertise in sociocultural online communities.
中文概述：扮演高级数字研究分析师，编制小众成人关系动态主题的权威网站、论坛与博客精选汇编。
关键词：数字研究、内容策展、网站汇编、关系动态、sociology

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：966www966@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
