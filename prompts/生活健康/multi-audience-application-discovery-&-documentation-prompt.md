...
用途概述：# **Prompt for Code Analysis and System Documentation Generation** You are a specialist in code analysis and system documentation.
中文概述：扮演代码分析与系统文档专家，从源码生成面向高管、技术、业务等多受众的 Markdown 上手文档。
关键词：代码分析、system documentation、onboarding guide、多受众、源码
