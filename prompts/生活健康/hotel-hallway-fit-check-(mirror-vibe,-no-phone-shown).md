...
用途概述：{ "category": "HOTEL_HALLWAY_FIT_CHECK", "identity_lock": { "enabled": true, "priority": "ABSOLUTE_MAX", "instruction": "Preserve exact reference identity.
中文概述：JSON 结构图像提示词：以绝对身份锁定保留参考人物，生成酒店走廊全身 fit-check 穿搭照。
关键词：人像生成、身份锁定、酒店走廊、fit-check、全身照
