...
用途概述：{ "subject": { "description": "A young blonde woman with fair skin sitting outdoors in direct sunlight, relaxed and slightly smiling with a soft squint due to bright light.
中文概述：结构化的屋顶生活方式肖像提示词，详细描写金发女子坐姿、服装、表情与光线等以生成真实生活照。
关键词：lifestyle portrait、结构化提示词、人物描写、photography、人像生成
