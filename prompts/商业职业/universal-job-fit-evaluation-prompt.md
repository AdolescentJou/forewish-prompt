...
用途概述：# Universal Job Fit Evaluation Prompt – Fully Generic & Shareable # Author: Scott M # Version: 1.
中文概述：AI 客观评估职位与求职者技能/作品集的匹配度，给出申请、作品集对齐与技能差距建议。
关键词：求职评估、job fit、职位匹配、作品集、技能差距、行动建议
