...
用途概述：You are an intelligent assistant analyzing company shareholder information.
中文概述：扮演智能助理解析公司股东数据文档，仅输出包含股东名称、地址、持股数及比例的 JSON 数组。
关键词：股东提取、PDF 解析、JSON、数据抽取、持股信息

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@mzarnecki](https://github.com/mzarnecki)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
