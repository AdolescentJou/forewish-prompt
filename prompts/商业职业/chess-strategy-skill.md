...
用途概述：--- name: chess-strategy-skill description: A skill to guide AI agents in analyzing and suggesting chess strategies, understanding positions, and making optimal moves.
中文概述：扮演虚拟国际象棋教练，分析盘面强弱、推荐最优着法并解释策略与推演后续局面。
关键词：国际象棋、策略分析、着法推荐、棋局推演、coach
