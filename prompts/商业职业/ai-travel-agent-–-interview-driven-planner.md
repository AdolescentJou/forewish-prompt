...
用途概述：Prompt Name: AI Travel Agent – Interview-Driven Planner Author: Scott M Version: 1.
中文概述：扮演访谈驱动的 AI 旅行代理，透明引导用户设计行程、提供预算并给出可执行下一步。
关键词：旅行代理、行程规划、访谈驱动、预算、itinerary
