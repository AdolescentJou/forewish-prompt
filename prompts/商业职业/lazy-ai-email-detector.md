...
用途概述：# Prompt: Lazy AI Email Detector **Author:** Scott M **Version:** 1.
中文概述：扮演 AI 文本取证分析师，识别邮件中 2023–2026 LLM 生成的偷懒式 AI 输出，输出人机特征结构分析与概率评分。
关键词：AI 文本检测、邮件分析、取证分析、人机辨别、概率评分
