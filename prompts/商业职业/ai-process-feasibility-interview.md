...
用途概述：# Prompt Name: AI Process Feasibility Interview # Author: Scott M # Version: 1.
中文概述：通过结构化访谈评估某流程是否适合用 AI 支持或自动化，推荐引擎并生成 starter prompt。
关键词：AI 可行性、流程评估、访谈、自动化、starter prompt
