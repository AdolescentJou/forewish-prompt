...
用途概述：# **🔥 Universal Lead & Candidate Outreach Generator** ### *AI Prompt for Automated Message Creation from LinkedIn JSON + PDF Offers* --- ## **🚀 Global Instructi
中文概述：AI 结合 LinkedIn JSON 与 PDF 职位/产品信息，为每位候选人或客户生成一条定制外联消息。
关键词：外联消息、LinkedIn、lead、HR、sales、个性化

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@nnassili-z0](https://github.com/nnassili-z0)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
