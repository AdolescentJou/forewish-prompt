...
用途概述：# AI Prompt: Gathering Planner Interview ## Versioning & Notes - **Author:** Scott M - **Version:** 4.
中文概述：以互动式访谈引导活动规划，采集需求后生成聚会方案，并可附带多风格邀请函模板。
关键词：活动策划、聚会规划、访谈式、邀请函、event planning
