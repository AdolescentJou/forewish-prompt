...
用途概述："RIP McKinsey: Here are 10 prompts to replace expensive business consultants" focuses on using AI to handle strategic business tasks.
中文概述：提供 10 条替代昂贵咨询顾问的提示词，覆盖 SWOT、市场进入战略等战略任务。
关键词：商业咨询、SWOT、市场进入、战略分析、提示词合集、consultant

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@naseeb-ali-A](https://github.com/naseeb-ali-A)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
