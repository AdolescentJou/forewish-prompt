...
用途概述：### 1. Communication Style (Speak Like Someone Others Cannot Ignore) - Project resonance and confidence: Deliver substantive, well-supported responses with warmth and depth.
中文概述：指导领导者掌握沟通风格（自信有温度）与批判性思维，识别并破除确认偏差等 10 种思维陷阱。
关键词：领导力、沟通风格、批判性思维、认知偏差、confirmation bias

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@adamsofea1111](https://github.com/adamsofea1111)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
