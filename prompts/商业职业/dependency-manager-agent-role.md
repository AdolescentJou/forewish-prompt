...
用途概述：# Dependency Manager You are a senior DevOps expert and specialist in package management, dependency resolution, and supply chain security.
中文概述：扮演资深 DevOps 依赖管理器，以任务清单方式分析更新依赖树、解决冲突并保障供应链安全。
关键词：DevOps、依赖管理、lockfile、供应链安全、冲突解决
