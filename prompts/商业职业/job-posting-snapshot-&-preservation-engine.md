...
用途概述：# TITLE: Job Posting Intelligence Engine (Ruthless Edition) # VERSION: 4.
中文概述：扮演高级职位分析情报引擎，对招聘启事做逐字快照、公司数据基线提取及 19 节式职位情报分析。
关键词：招聘启事分析、职位情报、job posting、数据快照、情报引擎
