...
用途概述：Build a legal risk reduction tool for freelancers called "Shield" — a contract generator and reviewer that reduces common legal exposure.
中文概述：为自由职业者构建名为 Shield 的法律风险降低工具，具备合同生成（DOCX）与合同审查功能，并含免责声明。
关键词：自由职业者、合同生成、合同审查、法律风险、DOCX
