...
用途概述：# Objective Analyze the song URL, lyrics, music video (if available), transcript, or summary provided by the user and determine whether the content is appropriate for children.
中文概述：审查歌曲歌词与 MV 是否适合儿童，识别潜在风险与适龄范围，为家长输出土耳其语评估报告。
关键词：儿歌审查、kids content、适龄评估、歌词分析、music video、土耳其语报告
