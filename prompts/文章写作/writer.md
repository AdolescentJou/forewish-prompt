...
用途概述：1. Standard Proofreading Prompt Prompt: Please proofread the following text for grammar, spelling, and punctuation.
中文概述：AI 扮演校对员与文案编辑，提供标准校对与详细 copyediting 提示：修正语法拼写并给出修正版与改动清单。
关键词：校对、Proofreading、Copyediting、语法修正、文案润色

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@this-is-lab](https://github.com/this-is-lab)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
