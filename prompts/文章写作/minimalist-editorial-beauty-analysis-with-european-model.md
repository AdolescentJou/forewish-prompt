...
用途概述：{ "prompt": "A minimalist editorial beauty analysis board featuring a European female model with a balanced oval-to-heart face shape and a softly defined jawline.
中文概述：生成欧洲女模特的极简 editorial 美编分析板图像：素颜/带妆对照、面部特征描述与蓝色轮廓线。
关键词：图像生成、beauty analysis、European model、面部特征、editorial
