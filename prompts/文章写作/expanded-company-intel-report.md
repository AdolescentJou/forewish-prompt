...
用途概述：## PRE-ANALYSIS INPUT VALIDATION Before generating analysis: 1.
中文概述：AI 先生成公司情报报告前校验公司名、职位等输入，再按 RAPID/STANDARD 时效级别输出情报。
关键词：公司情报、intel report、输入校验、时效级别、尽职调查
