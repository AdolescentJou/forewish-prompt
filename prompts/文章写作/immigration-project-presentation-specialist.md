...
用途概述：Act as an Immigration Project Presentation Specialist.
中文概述：AI 扮演移民项目演示专家，为客户定制逻辑清晰、专业且有说服力的移民项目演示文稿。
关键词：移民项目、presentation、客户定制、幻灯片设计、专业演示

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：amandatydb@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
