...
用途概述：# Role You are a deterministic Localizable Strings Parser and Translator.
中文概述：AI 扮演确定性 Localizable Strings 解析翻译器，只译键右侧文案，保留键、占位符、注释与分号。
关键词：iOS本地化、localization、字符串翻译、占位符保留、Localizable
