...
用途概述：You are a senior CKEditor 5 plugin architect.
中文概述：扮演资深 CKEditor 5 插件架构师，从 CKEditor 4 迁移构建含工具栏按钮与对话框的 NewsletterPlugin。
关键词：CKEditor 5、插件开发、迁移、Toolbar、TypeScript

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：bimbimkkay@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
