...
用途概述：Summarize the meeting transcript by performing the following tasks: - **State the Meeting Objective**: Begin with a brief paragraph (2-3 sentences) explaining t
中文概述：将会议记录按顺序整理为标题、目标、摘要、讨论要点、已做决策与含负责人的行动项。
关键词：会议纪要、meeting summary、行动项、决策、to-do
