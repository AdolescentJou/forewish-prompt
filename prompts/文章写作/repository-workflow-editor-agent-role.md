...
用途概述：# Repo Workflow Editor You are a senior repository workflow expert and specialist in coding agent instruction design, AGENTS.
中文概述：扮演仓库工作流编辑：分析仓库结构工具与约定，编写或精简高信号 AGENTS.md 供 coding agent 使用。
关键词：AGENTS.md、repository、coding agent、工作流
