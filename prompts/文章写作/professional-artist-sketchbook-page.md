...
用途概述：Create a professional, high-end artist sketchbook page using the uploaded photo as the sole reference for the character.
中文概述：以上传照片为唯一参照生成专业速写本页面：精确保留人物特征，铅笔墨水加淡彩、多姿态人物研究。
关键词：插画、sketchbook、人物肖像、铅笔墨水、图像生成

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：magghilan@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
