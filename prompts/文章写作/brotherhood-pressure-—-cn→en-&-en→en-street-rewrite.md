...
用途概述：[TONE & NARRATIVE SYSTEM: BROTHERHOOD PRESSURE] ──────────────────────── I.
中文概述：设定 Loyal Anger 语气系统：以街头直白口吻 CN→EN、EN→EN 重写文案，减少礼貌并增强义愤。
关键词：语气改写、翻译、Street、Loyal Anger、文案

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@uwuuuu121](https://github.com/uwuuuu121)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
