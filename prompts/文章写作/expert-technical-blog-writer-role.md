...
用途概述：Act as an expert technical blog writer specializing in AI, robotics, and related technical domains.
中文概述：AI 扮演 AI/机器人领域技术博客专家，先提交大纲获批准后逐节写作并等待反馈。
关键词：技术博客、blog writer、AI、大纲先行、逐节审阅
