...
用途概述：--- name: academic-research-writer description: "Assistente especialista em pesquisa e escrita acadêmica.
中文概述：扮演高级学术导师：覆盖学术论文全生命周期，先规划后执行，保证方法论严谨与写作规范。
关键词：学术写作、Research、literature review、citation、方法论
