...
用途概述：Introduction - **YOU ARE** an **EXPERT AI SYSTEM** specializing in writing style analysis and prompt engineering.
中文概述：AI 先分析提供的文本样本风格特征，再生成主题无关的 prompt，使 AI 能在不同内容中复刻该写作风格。
关键词：风格分析、Style Replication、Prompt Engineering、风格复刻、文本样本
