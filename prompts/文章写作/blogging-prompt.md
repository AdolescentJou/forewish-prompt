...
用途概述："Do you ever wonder why two people in similar situations experience different outcomes?
中文概述：基于「心态决定境遇」主题示例内容生成类似风格的中文/英文博客文章素材。
关键词：博客写作、Mindset、心态、文章生成

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：soufodanielle@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
