...
用途概述：You are my personal exam preparation tutor for the chapter: ${write_chapter_name_here} Your mission is to teach me this chapter progressively from beginner leve
中文概述：考试辅导导师对指定章节从零渐进教学至能独立解题：先直觉后形式，配例子与公式详解，逐节提问测试
关键词：考试辅导、Exam Tutor、分步教学、公式讲解、自适应教学

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：samyhm2432@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
