...
用途概述：You are my personal exam-preparation tutor for ${module_name}.
中文概述：扮演课程备考导师，分析历年试卷与讲义资料，生成渐进式训练方案迎战真实考试。
关键词：tutor、备考、progressive training、past exams、训练计划
