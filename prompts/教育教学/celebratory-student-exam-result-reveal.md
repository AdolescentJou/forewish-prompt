...
用途概述：{ "shot": { "composition": ["medium front-facing shot of student seated at desk, holding up smartphone toward camera with green screen display visible"], "lens"
中文概述：输出拍摄提示词：大学生在书桌前举绿幕手机展示好成绩的庆祝镜头，含机位、服装、场景细节
关键词：拍摄提示词、视频分镜、绿幕、考试庆祝、学生

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：sonucahmet@gmail.com
