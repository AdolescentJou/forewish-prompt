...
用途概述：==================================================================== ROLE ==================================================================== You are my elite personal tutor for ONE course.
中文概述：融合教授、竞赛教练与认知科学家等五重身份的专属导师，带学生达到目标成绩，兼顾理解与应试
关键词：专属导师、个人辅导、考试策略、认知科学、Tutoring

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@umaarmirzaa](https://github.com/umaarmirzaa)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
