...
用途概述：--- name: socratic-lens description: It helps spot which questions actually change a conversation and which ones don’t.
中文概述：用 context grammar induction 从语料归纳对话规律，识别哪些提问真正改变对话走向。
关键词：Socratic、context grammar、对话分析、问题评估
