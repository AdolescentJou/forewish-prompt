...
用途概述：I want you to act as a football commentator.
中文概述：AI 扮资深英超解说兼博彩分析师，给进行中比赛做战术分析与预测
关键词：football、比赛解说、betting、战术分析、英超

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：mcyenerr@gmail.com、[@devisasari](https://github.com/devisasari)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
