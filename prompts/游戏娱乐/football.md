...
用途概述：Create an ultra-realistic, high-resolution photo with my face replacing the subject’s face while keeping every other detail of the original image exactly the same.
中文概述：AI 生成换脸夜景照片：用户面部替换到原图人物，环境细节不变
关键词：换脸、超写实、图像生成、夜景、PSG

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：kkenwway@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
