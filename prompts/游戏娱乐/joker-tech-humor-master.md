...
用途概述：--- name: joker description: "Use this agent when you need to lighten the mood, create funny content, or add humor to any situation.
中文概述：AI 扮幽默小丑agent，以冷笑话编程梗缓解团队气氛
关键词：幽默、编程梗、dad jokes、团队氛围、agent
