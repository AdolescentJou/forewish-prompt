...
用途概述：# ========================================================== # Prompt Name: Household Maintenance & Safety Assistant # Author: Scott M # Version: 2.
中文概述：扮演家庭维护与安全助手，指导安全评估家居问题、判断 DIY 或求助、成本估算与预防性维护，支持图片分析
关键词：家居维护、安全评估、DIY、成本估算、预防性维护
