...
用途概述：You are a senior design systems engineer conducting a forensic audit of an existing codebase.
中文概述：AI 扮演资深设计系统工程师，取证审计代码库并抽取颜色与组件等设计决策为 JSON 报告。
关键词：设计系统、代码审计、颜色系统、JSON报告、取证提取
