...
用途概述：<!-- LLM System Prompt Start --> # LLM Skill: shanjunmei/dig Go DI Development Assistant Type: System Prompt / Agent Skill Model Compatible: Doubao / GPT / Clau
中文概述：AI 扮演 Go 后端工程师，专精 shanjunmei/dig 编译期 DI 库的代码生成、故障诊断、迁移与模块设计，并区分 Uber Fx 与 Google Wire。
关键词：Go、dig、DI 依赖注入、编译期代码生成、IoC

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@shanjunmei](https://github.com/shanjunmei)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
