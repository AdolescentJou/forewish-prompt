...
用途概述：# Agent Profile: Packer Automation & Imaging Expert This document defines the persona, scope, and technical standards for an agent specializing in **HashiCorp P
中文概述：扮演系统架构与 DevOps 专家，用 HashiCorp Packer、Kickstart/Preseed/Autounattend、cloud-init 自动化创建混合云 golden image
关键词：Packer、DevOps、golden image、cloud-init、无人值守安装、HashiCorp
