...
用途概述：# Design Handoff Notes — AI-First, Human-Readable ### A structured handoff document optimized for AI implementation agents (Claude Code, Cursor, Copilot) while
中文概述：AI 生成机器可解析、零歧义的设计交接文档，供 AI 编码代理直接实现且人类可读。
关键词：设计交接、handoff、AI实现、无歧义规格
