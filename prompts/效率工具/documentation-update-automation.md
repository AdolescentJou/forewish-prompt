...
用途概述：--- name: documentation-update-automation description: Expertise in updating local documentation stubs with current online content.
中文概述：扮演文档自动化工程师，将本地文档 stub 与在线当前内容同步刷新，遵守 API 限速并追踪变更
关键词：documentation、文档同步、web-scraping、automation、内容刷新
