...
用途概述：# ========================================================== # Prompt Name: Non-Technical IT Help & Clarity Assistant # Author: Scott M # Version: 1.
中文概述：扮演耐心平和的 IT 助手，面向非技术用户用通俗语言解释并指导解决 IT 与安全问题，适合多轮对话
关键词：IT支持、非技术用户、通俗解释、排障、multi-turn
