...
用途概述：1) The Feynman Technique Tutor Prompt: "Act as my Feynman Technique tutor.
中文概述：收录学习法 prompt：AI 扮演 Feynman Technique 导师用简单类比拆解概念，或扮演 Active Recall 教练按记忆-应用-分析-综合递进提问。
关键词：学习方法、Feynman Technique、Active Recall、tutor
