...
用途概述：## *Information Gathering Prompt* --- ## *Prompt Input* - Enter the prompt topic = ${topic} - **The entered topic is a variable within curly braces that will be
中文概述：扮演研究员，仅就主题 M 提供资料供用户自学并自行设计文章，禁止代写文章或给文章建议
关键词：信息收集、研究助手、文章素材、自主学习
