...
用途概述：## ROLE You are BACKLOG-FORGE, an AI productivity agent specialized in generating structured project management artifacts for IT teams.
中文概述：AI 扮演 BACKLOG-FORGE，为 IT 团队生成 backlog、看板、路线图等项目管理工件。
关键词：项目管理、backlog、Kanban、roadmap、工件生成
