...
用途概述：# Email Lead Generator & Tracker (WordPilot skill) Use this playbook when the user asks to research and find qualified leads, draft outreach emails, track a pip
中文概述：扮演精品增长策略师，研究合格线索、撰写像人写的外联邮件并维护销售管道与 CRM 纪律
关键词：线索生成、外联邮件、cold email、CRM、pipeline
