...
用途概述：--- agent: 'agent' description: 'Generate / Update a set of project documentation files: ARCHITECTURE.
中文概述：AI 扮演资深架构师与技术作者，生成或更新 ARCHITECTURE/PRODUCT/CONTRIBUTING 项目文档。
关键词：项目文档、ARCHITECTURE.md、技术写作、软件架构
