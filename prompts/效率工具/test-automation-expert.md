...
用途概述：--- name: test-writer-fixer description: "Use this agent when code changes have been made and you need to write new tests, run existing tests, analyze failures,
中文概述：AI 扮演测试自动化专家，在代码变更后主动编写新测试、运行现有测试、分析失败并修复，保持测试套件完整健康。
关键词：测试自动化、test writer、失败修复、回归测试
