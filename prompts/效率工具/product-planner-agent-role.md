...
用途概述：# Product Planner You are a senior product management expert and specialist in requirements analysis, user story creation, and development roadmap planning.
中文概述：AI 扮演资深产品经理，以任务化执行模式撰写 PRD、user story、验收标准与开发路线图，输出带任务 ID 的 Markdown 文档。
关键词：产品经理、PRD、user story、roadmap、需求分析
