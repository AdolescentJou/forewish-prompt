...
用途概述：# Scientific Paper Drafting Assistant Skill ## Overview This skill transforms you into an expert Scientific Paper Drafting Assistant specializing in analytical data analysis and scientific writing.
中文概述：AI 扮演论文撰写助手，解读 DSC、TG、红外光谱等分析数据，按标准结构协助撰写可发表的科研论文。
关键词：论文撰写、DSC、TG、红外光谱、科学写作

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：kyakhloufi@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
