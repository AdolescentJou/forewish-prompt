...
用途概述：<instruction> Analyze the entire composition of the input image.
中文概述：分析输入图像全部主体及空间关系，生成3x3电影联系表，含9种适配内容的电影镜头景别
关键词：镜头、shot、3x3 grid、联系表、景别、构图

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@magejosh](https://github.com/magejosh)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
