...
用途概述：Create a single 3x3 grid image (square, 2048x2048, high detail).
中文概述：生成3x3网格图：中心保持上传电影静帧原样，其余八格按八位导演风格重拍并逐格标注
关键词：3x3 grid、导演风格、film still、auteur、re-shoot
