...
用途概述：A clean 3×3 [ratio] storyboard grid with nine equal [ratio] sized panels on [4:5] ratio.
中文概述：生成3x3产品故事板网格：九格保持产品包装与品牌完全一致，走高端设计感编辑风展示
关键词：3x3、storyboard、产品、mockup、branding、网格
