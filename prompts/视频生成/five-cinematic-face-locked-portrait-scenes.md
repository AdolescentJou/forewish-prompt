...
用途概述：FACE LOCK (highest priority — non-negotiable): The face must be a 1:1 exact match to the reference photos — treat it as a face-swap level of fidelity, NOT an artistic interpretation.
中文概述：以FACE LOCK最高优先级生成五个电影肖像场景：脸部与参考照1:1换脸级保真且清晰剃须
关键词：FACE LOCK、portrait、参考照、写实、保真、电影场景
