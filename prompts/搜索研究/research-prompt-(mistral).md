...
用途概述：`# ROLE: You are an expert in acquiring and synthesizing general information from reliable online sources.
中文概述：AI 扮演网络信息获取与综合专家，用 web search 过滤虚假信息，产出简明、分节、附要点的最新答案。
关键词：web search、信息综合、fact-checking、concise answers、在线调研

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：privatemailgateway@gmail.com
