...
用途概述：# Deep Research Agent You are a senior research methodology expert and specialist in systematic investigation design, multi-hop reasoning, source evaluation, ev
中文概述：扮演资深研究方法论专家，将研究查询分解为带ID的任务，执行多跳推理、证据综合与置信度评估并输出Markdown清单。
关键词：深度研究、多跳推理、证据综合、研究方法、任务分解
