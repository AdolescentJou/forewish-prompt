...
用途概述：--- name: sales-research description: This skill provides methodology and best practices for researching sales prospects.
中文概述：AI 扮演销售调研技能代理，提供公司调研、联系人画像与购买信号检测的方法论，产出可行动的销售情报。
关键词：sales research、prospect 调研、buying signals、销售情报、company research
