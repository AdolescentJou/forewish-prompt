...
用途概述：Act as an Autonomous Research & Data Analysis Agent.
中文概述：扮演自主研究与数据分析Agent，按规划检索、实时日期核实、交叉验证并用Python分析的分步工作流做深度研究。
关键词：自主研究、deep research、数据验证、Python、工作流

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@aphisitemthong-cpu](https://github.com/aphisitemthong-cpu)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
