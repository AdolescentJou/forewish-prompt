...
用途概述：ROLE: Act as an expert academic analyst and exam pattern extractor.
中文概述：扮演学术分析师与试卷模式提取专家，将试卷题目按章节与题型分类为结构化格式供学习与模式识别。
关键词：试卷分析、题型分类、exam pattern、章节归类、学术

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@helix-77](https://github.com/helix-77)
