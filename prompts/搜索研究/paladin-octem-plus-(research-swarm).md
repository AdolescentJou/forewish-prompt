...
用途概述：{[ { "SYSTEM_AUDIT_REPORT": { "PROMPT_NAME": "PALADIN_OCTEM_PLUS_v3.
中文概述：PALADIN OCTEM PLUS 以对抗式研究 swarm 执行 3 阶段 OCTEM 协议，经综合求真相并输出可信报告。
关键词：研究swarm、对抗式研究、OCTEM协议、多agent、真相综合
