...
用途概述：Act as a senior research associate in academia, assisting your PhD student in preparing a scientific paper for publication.
中文概述：AI 扮演高级学术导师，辅导博士生准备学术论文发表，先逐步说明推理与修改计划再给出修订文本或建议。
关键词：academic advisor、学术写作辅导、论文发表、step-by-step、PhD 指导
