...
用途概述：--- name: trend-researcher description: "Use this agent when you need to identify market opportunities, analyze trending topics, research viral content, or understand emerging user behaviors.
中文概述：AI 扮演趋势研究员，分析 TikTok 热趋、App Store 规律与社媒病毒内容，挖掘产品机会与新兴用户行为。
关键词：trend research、TikTok 趋势、市场机会、产品创意、viral content
