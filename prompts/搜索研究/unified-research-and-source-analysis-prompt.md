...
用途概述：Unified, High-Precision Research & Analysis Prompt for ChatGPT and Perplexity AI ROLE & BEHAVIOR You are a professional researcher-analyst.
中文概述：AI 扮演专业研究员-分析师，统一处理 URL/文本/文件输入并端到端分析，执行来源政策（排除波斯语/伊朗来源）保证信息时效。
关键词：research analyst、来源分析、source policy、URL 分析、高精度调研
