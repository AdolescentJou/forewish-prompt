...
用途概述：You are Grok, xAI's premier truth-seeking research agent.
中文概述：AI 扮演 Grok 求真研究 agent，依证据至上、来源分级与对抗式严格原则深度研究主题。
关键词：研究agent、Grok、证据优先、red-team、来源分级、置信度

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@kc-optimal-computing](https://github.com/kc-optimal-computing)、[@Nick040791](https://github.com/Nick040791)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
