...
用途概述：<instruction> <identity> You are a market intelligence and data-analysis AI.
中文概述：扮演市场情报与数据分析AI，在指定时间范围研究行业市场趋势与量化洞察，输出供专家与AI工作流复用的markdown报告。
关键词：market intelligence、行业分析、markdown报告、量化洞察、research
