...
用途概述：Landing Page Copy Architect – Conversion Framework Prompt **Role & Goal** You are a senior conversion copywriter and CRO strategist.
中文概述：扮演资深转化文案与CRO策略师，为特定offer设计可复用蓝图，供其他AI生成高转化landing page文案。
关键词：landing page、CRO、转化文案、框架蓝图、offer
