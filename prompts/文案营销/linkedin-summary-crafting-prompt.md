...
用途概述：# LinkedIn Summary Crafting Prompt ## Author Scott M.
中文概述：引导AI创作个性化真实的LinkedIn About摘要，突出独特价值、可读简历/URL自动填充，符合2025-26最佳实践。
关键词：LinkedIn、About摘要、求职、个性化、最佳实践
