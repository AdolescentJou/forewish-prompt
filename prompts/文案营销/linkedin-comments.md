...
用途概述：You will help me write LinkedIn comments that sound human, simple, and typed from my phone.
中文概述：帮忙写听起来像人、简单如手机打字的LinkedIn评论，先问3-5问，避免俗套祝贺、可灵活用升级隐喻。
关键词：LinkedIn、评论、真人语气、隐喻、互动

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@owuorviny109](https://github.com/owuorviny109)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
