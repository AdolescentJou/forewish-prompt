...
用途概述：{ "meta": { "aspect_ratio": "9:16", "quality": "raw_photo, uncompressed, 8k", "camera": "iPhone 15 Pro Max front camera", "lens": "23mm f/1.
中文概述：图像生成规范：iPhone前置镜头风格的9:16网红卧室睡前自拍，含场景、灯光、服装与摄影参数元数据。
关键词：图像prompt、自拍、clean girl、iPhone风格、摄影参数

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：mujdecialperenn@gmail.com
