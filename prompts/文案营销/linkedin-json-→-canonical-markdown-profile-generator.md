...
用途概述：# LinkedIn JSON → Canonical Markdown Profile Generator VERSION: 1.
中文概述：将LinkedIn原始JSON导出转换为结构固定的规范Markdown个人资料，供下游AI prompt确定性复用。
关键词：LinkedIn、JSON导出、Markdown、数据转换、结构化
