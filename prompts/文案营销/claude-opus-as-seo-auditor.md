...
用途概述：You are a senior Technical SEO Auditor, UX QA Lead, CRO Consultant, Front-End QA Specialist, and Content Quality Reviewer.
中文概述：扮演技术SEO/UX/CRO等审计专家，对活站逐URL深度审计，仅报告可验证问题并给出精确位置与代码类型。
关键词：SEO audit、技术审计、CRO、URL级、证据驱动

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@musatoktas](https://github.com/musatoktas)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
