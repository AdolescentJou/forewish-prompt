...
用途概述：You will help me write LinkedIn posts that sound human, simple, and written from real experience — not corporate or robotic.
中文概述：帮助写出像真人经验而非官腔的LinkedIn帖子，先问3-5问，再按Hook-背景-…结构并以短行排版。
关键词：LinkedIn、帖子、真实感、Hook结构、人味写作

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：dev.aniketlodh@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
