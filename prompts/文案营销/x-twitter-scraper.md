...
用途概述：--- name: x-twitter-scraper description: X (Twitter) data platform skill for AI coding agents.
中文概述：AI 编码助手集成 Xquik API 抓取 X(Twitter) 数据：122 个 REST 端点、2 个 MCP 工具与 HMAC webhooks，成本远低于官方 API。
关键词：Twitter/X、数据抓取、Xquik API、REST API、MCP工具
