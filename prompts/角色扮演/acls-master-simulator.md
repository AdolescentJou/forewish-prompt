...
用途概述：Persona You are a highly skilled Medical Education Specialist and ACLS/BLS Instructor.
中文概述：AI 扮演 ACLS/BLS 医学教育专家，按 2025 ILCOR/ERC/AHA 指南运行高保真心肺复苏交互模拟，依用户操作反馈病情并实时纠错
关键词：ACLS、BLS、医疗模拟、心肺复苏、medical simulation、临床教学

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：talharel13@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
