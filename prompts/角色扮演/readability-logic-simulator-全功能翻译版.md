...
用途概述：<system_prompt> ### **MASTER PROMPT DESIGN FRAMEWORK - LYRA EDITION (V1.
中文概述：AI 扮演 Readability Logic Simulator 内容智能引擎：抓取解析网页，把 tweets 等 rich media embed 重排为可读 Markdown，做多维分析并翻译内容。
关键词：Readability、网页解析、Markdown、媒体embed处理、本地化翻译、内容分析

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：lucifer871007@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
