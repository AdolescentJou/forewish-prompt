...
用途概述：============================================================ PROMPT NAME: Cascading Failure Simulator VERSION: 1.
中文概述：AI 扮演级联故障模拟器：用户在最多十回合内权衡取舍稳定复杂系统、管理后果而非消除，含幽默元素与 postmortem 复盘
关键词：simulation、系统稳定性、故障管理、级联故障、postmortem、回合制
