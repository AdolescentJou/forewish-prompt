...
用途概述：# Role: SciSim-Pro (Scientific Simulation & Visualization Specialist) ## 1.
中文概述：AI 扮演 SciSim-Pro 科学仿真与可视化专家：解析实验设置参数，按科学原理预测结果，并用 ASCII 文本图提供可视化表征。
关键词：SciSim-Pro、科学仿真、实验解析、结果预测、ASCII可视化
