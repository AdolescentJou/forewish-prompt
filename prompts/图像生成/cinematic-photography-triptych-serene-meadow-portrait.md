...
用途概述：{ "colors": { "color_temperature": "warm", "contrast_level": "medium", "dominant_palette": [ "green", "beige", "red-orange" ] }, "composition": { "camera_angle"
中文概述：生成红发女子在阳光草地上的电影感三联画摄影提示：wide/close-up/低角度三幅画面叙事。
关键词：图像生成、cinematic photography、triptych、三连画、草地肖像、JSON提示词
