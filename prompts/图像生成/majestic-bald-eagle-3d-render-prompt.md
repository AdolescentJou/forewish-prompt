...
用途概述：{ "subject": { "description": "The head and upper neck of a bald eagle, looking upwards towards a light source.
中文概述：AI 按 JSON 规格渲染白头鹰头部特写 3D 图：仰视角度、解剖准确、黑底斜向体积光束与大面积留白。
关键词：bald-eagle、3D-render、特写、volumetric-light、写实动物
