...
用途概述：Pixar-style, Disney-style, high quality 3D render, octane render, global illumination, subsurface scattering, ultra detailed, soft cinematic lighting, cute and warm mood.
中文概述：将一家三口照片转为 Pixar 风格 3D 角色壁纸:墙后探头嬉戏,保留真实面部相似度
关键词：图像生成、Pixar 风格、3D 渲染、家庭壁纸、octane

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：umutcanyildiz@gmail.com
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
