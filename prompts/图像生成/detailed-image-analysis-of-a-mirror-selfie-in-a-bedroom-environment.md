...
用途概述：{ "image_analysis": { "environment": { "type": "Indoor", "location_type": "Bedroom or Living Area", "spatial_depth": "Reflected depth via mirror", "background_e
中文概述：以 JSON 详细分析卧室镜前自拍：环境、相机规格、光线来源方向及人物姿势等全要素。
关键词：图像分析、JSON输出、镜前自拍、光线分析、场景描述
