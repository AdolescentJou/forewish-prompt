...
用途概述：{ "model": "nano-banana", "task": "image_to_image_product_enhancement", "objective": "Transform the input product image into a professional commercial studio ph
中文概述：AI 把产品图转为白底专业商业棚拍，严格保留产品身份、几何、材质与纹理
关键词：图像转换、product photography、studio lighting、identity preservation、纯白背景
