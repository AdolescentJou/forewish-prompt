...
用途概述：A premium iOS app icon for a running and fitness app, featuring a stylized abstract runner figure in motion, composed of flowing gradient ribbons in energetic coral transitioning to vibrant magenta.
中文概述：按 premium iOS 图标规范生成跑步健身应用图标：渐变丝带抽象跑者、深蓝背景、1024px 圆角方形。
关键词：app icon、iOS设计、跑步健身、渐变、1024px、UI图标
