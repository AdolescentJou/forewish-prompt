...
用途概述：{ "colors": { "color_temperature": "cool", "contrast_level": "high", "dominant_palette": [ "teal", "cool gray", "warm yellow", "orange" ] }, "composition": { "c
中文概述：AI 依结构化参数生成月光下临水街景数字插画，暖光咖啡馆配黑猫冷调高对比
关键词：插画生成、digital illustration、夜景街景、moonlit、参数化描述
