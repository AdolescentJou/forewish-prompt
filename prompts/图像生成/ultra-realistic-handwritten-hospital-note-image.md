...
用途概述：Create an ultra-realistic image depicting a handwritten note on a clean, flat surface.
中文概述：AI 生成病床场景桌上手写遗书风格信件图，深蓝笔迹自然逼真融于纸面
关键词：图像生成、handwritten、医院场景、写实手写、letter

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@Beatrix9](https://github.com/Beatrix9)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
