...
用途概述：{ "environment": { "type": "outdoor", "location": "staircase", "setting": "garden_or_park_entrance", "time_of_day": "mid_day", "weather": "sunny" }, "camera": {
中文概述：结构化分析户外阶梯人像照片,输出环境、相机、光线、姿态与情绪等 JSON 标注
关键词：图像分析、JSON 输出、人像、摄影标注、结构化
