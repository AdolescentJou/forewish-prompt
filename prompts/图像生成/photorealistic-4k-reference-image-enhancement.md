...
用途概述："Ultra-high-resolution 4K enhancement based strictly on the provided reference image.
中文概述：严格基于参考图做 4K 增强:脸部身份构图光线零偏差,只提清晰度动态范围并去噪
关键词：图像生成、4K 增强、参考图、写实还原、保真
