...
用途概述：{ "image_analysis": { "meta": { "type": "photorealistic", "style": "mirror_selfie_low_key", "subject_count": 1, "aesthetic": "moody_allure_social_media_aestheti
中文概述：结构化分析低光红色调浴室镜面自拍:逐项输出环境、相机参数、光线与身体细节
关键词：图像分析、mirror selfie、JSON 输出、低光、细节标注
