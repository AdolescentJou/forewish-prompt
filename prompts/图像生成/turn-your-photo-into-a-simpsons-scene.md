...
用途概述：Use the uploaded photo as the ONLY reference for composition and subjects.
中文概述：AI 依上传照片将全部人物动物转为《辛普森一家》画风，保持数量姿态身份锁定
关键词：图像转换、The Simpsons、卡通化、identity lock、经典画风
