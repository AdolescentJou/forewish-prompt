...
用途概述：{ "colors": { "color_temperature": "warm", "contrast_level": "high", "dominant_palette": [ "yellow", "blue", "red", "pink", "green", "orange" ] }, "composition"
中文概述：以 Fauvism 与 Pointillism 风格生成阳光客厅插画，用 JSON 结构化指定配色、构图与环境细节
关键词：Fauvism、Pointillism、客厅插画、暖色调、JSON 结构化
