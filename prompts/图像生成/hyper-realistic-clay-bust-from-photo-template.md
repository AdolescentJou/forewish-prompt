...
用途概述：Use the uploaded photo as the only identity reference.
中文概述：AI 依上传照片生成 hyper-realistic 手工 modeling clay（plasticine）半身像雕塑，保留五官表情、不做美化。
关键词：clay-sculpture、半身像、photoreal、照片转雕塑、手工质感
