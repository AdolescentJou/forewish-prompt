...
用途概述：{ "prompt": "You will perform an image edit using the people from the provided photo as the main subjects.
中文概述：以上传照片中人物为主体做图像编辑，面部保持不变，设计爸爸码农、宝宝捣乱等可爱卡通贴纸。
关键词：图像编辑、卡通贴纸、家庭主题、sticker design、面部保留
