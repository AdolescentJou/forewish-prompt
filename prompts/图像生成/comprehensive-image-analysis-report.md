...
用途概述：{ "meta": { "source_image": "user_provided_image", "analysis_timestamp": "2024-07-30T12:00:00Z", "analysis_model": "image_to_json_v1.
中文概述：AI 将用户提供的图片分析为结构化 JSON 报告，含相机 EXIF、场景环境、景深层次与置信度等。
关键词：图像分析、JSON输出、EXIF、image-to-json、场景识别
