...
用途概述：Create a realistic, poorly taken amateur photo of a physical smartphone showing a WhatsApp chat on its screen.
中文概述：AI 生成手持手机拍摄的 WhatsApp 土耳其语聊天实拍图，画质刻意业余逼真
关键词：图像生成、WhatsApp、amateur photo、realistic、土耳其语对话

## 元信息（仓库提供）

- 来源仓库：[f/prompts.chat](https://github.com/f/prompts.chat)
- 贡献者：[@f](https://github.com/f)、[@ekmekcicaner](https://github.com/ekmekcicaner)
- 类型：纯文本（原始类型 TEXT）
- 面向开发者：否
