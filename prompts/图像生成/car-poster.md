...
用途概述：${primary_text:Megane}{ "category": "STUDIO_RACE_CAR_SIDE_PROFILE", "subject": { "vehicle_type": "GT endurance race car", "base_form": "Modern GT-class silhouet
中文概述：生成 Megane 品牌 GT 耐力赛车的侧面摄影棚海报与涂装排版
关键词：赛车海报、GT赛车、品牌涂装、棚拍侧视图
