...
用途概述：{ "meta_data": { "task_type": "text_to_image_with_reference", "version": "v1.
中文概述：AI 依参考人脸严格保真生成昏暗台球酒吧写实竖图场景，含技术参数约束
关键词：图像生成、text-to-image、identity preservation、台球酒吧、photorealistic
