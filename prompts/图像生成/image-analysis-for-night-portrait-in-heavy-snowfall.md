...
用途概述：{ "image_analysis": { "meta": { "type": "photorealistic", "style": "candid_night_portrait", "subject_count": 1 }, "environment": { "type": "outdoor", "location"
中文概述：AI 输出结构化 JSON 分析：大雪夜晚室外 candid 人像照片的环境、混合光源与相机设置等规格解读。
关键词：image-analysis、夜景人像、大雪、摄影规格、JSON
